# 1. Заходим в Нейрокота и отправляем запрос: напиши код с использованием библиотеки selenium
# для парсинга цен с сайта[сайт]
# 2. Копируем код, вставляем в файл и удаляем лишнее.
# 3. Отправляем запрос: измени данный код так, чтобы информация о ценах сохранялась в csv файл
# 4. Копируем нужную часть кода, вставляем в файл.
